...
public class StupidControllerStuff extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(this.gamepad2.right_trigger > 0) {
                ...
                telemetry.addData("killme", 0);
            }

            //When the right trigger isn't down, no more conveyor
            else if (this.gamepad2.right_trigger == 0 && this.gamepad2.left_trigger == 0) {
